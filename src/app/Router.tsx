...
import { APP_ROUTES } from "./core/constants/publicPaths";
import {
  DASHBOARD_ROOT,
  DASHBOARD_SEGMENTS,
  buildDashboardPath,
} from "./core/constants/dashboardPaths";
...
const AngelicaLifePlan = lazy(
  () => import("./modules/shared/angelica-life-plan"),
);

// Lazy load dashboard pages
const AngelicaPage = lazy(
  () => import("./modules/dashboard/Pages/AngelicaPage"),
);
const ProfilePage = lazy(() => import("./modules/dashboard/Pages/ProfilePage"));
const SettingsPage = lazy(
  () => import("./modules/dashboard/Pages/SettingsPage"),
);
...
const NotFound = lazy(() =>
  import("./core/components/error/NotFound").then((module) => ({
...
const LoadingFallback = () => (
  <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900">
    <div className="text-center">
      <div className="inline-flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full border-4 border-blue-200 border-t-blue-600 dark:border-slate-700 dark:border-t-blue-400 animate-spin mb-4" />
