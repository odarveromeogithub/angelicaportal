    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="md:ml-60">
        <motion.main
          ...
          className="py-8 md:py-10 pb-4"
        >
          <div className="px-4 sm:px-5 md:px-6 lg:px-8 py-4 sm:py-5 md:py-6 space-y-5 sm:space-y-6">
            <h2 className="text-2xl md:text-3xl font-semibold text-gray-900">Profile Overview</h2>
              ...
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-base text-gray-600">
                    Complete facial verification to confirm your identity and unlock all features.
                  </p>
                </div>
              </div>
            </motion.div>
              ...
              <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                  <div>
                    ...
                    <p className="text-sm md:text-base font-medium text-gray-900 mt-1">{fullName}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <label className="text-xs md:text-sm text-gray-600">Phone Number</label>
                    <p className="text-sm md:text-base font-medium text-gray-900 mt-1">{phoneNumber}</p>
                  </div>
                  <div>
                    <label className="text-xs md:text-sm text-gray-600">Account Status</label>
                    <p className="text-sm md:text-base font-medium text-orange-600 mt-1">Unverified</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border border-blue-200 bg-blue-50">
              <CardHeader>
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <CardTitle className="text-base md:text-lg">Facial Verification Required</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-sm md:text-base text-gray-700 mb-4">
                  To verify your account, we need to confirm that you are the same person who uploaded the ID and signatures. 
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                  <div className="border-2 border-gray-300 rounded-xl p-6 md:p-8 h-40 md:h-48 flex items-center justify-center">
                    <p className="text-sm md:text-base text-gray-400">No signature uploaded</p>
                  </div>
                  <div className="flex items-center">
                    <ul className="list-disc list-inside text-xs md:text-sm text-gray-600 space-y-2">
                      <li>The Signature uploaded is protected by the data privacy law</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle className="text-base md:text-lg">ID with 3 Specimen Signature</CardTitle>
                <Button size="sm">
                  <Edit className="w-4 h-4 mr-2" />
                  Edit
                </Button>
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                  <div className="border-2 border-gray-300 rounded-xl p-6 md:p-8 h-48 md:h-64 flex items-center justify-center">
                    <p className="text-sm md:text-base text-gray-400">No ID uploaded</p>
                  </div>
                  <div className="flex items-center">
                    <ul className="list-disc list-inside text-xs md:text-sm text-gray-600 space-y-2">
                      <li>The ID and Signatures uploaded are protected by the data privacy law</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
