  ...
  return (
    <TooltipProvider>
      <motion.header
        ...
        className="fixed top-0 left-0 md:left-60 right-0 bg-white border-b border-gray-100 z-40 shadow-sm"
      >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl md:text-2xl font-semibold text-gray-900">
                  Welcome Back, <span className="text-blue-600 font-bold">{dashboardUser?.name || 'User'}</span>
                </h1>
              ...
              {tabs.map((tab) => (
                <button
                  ...
                  className={`relative pb-3 px-5 flex-shrink-0 transition-all ${
                    currentTab === tab.path ? 'bg-gray-50/50' : 'hover:bg-gray-50/30'
                  }`}
                >
                  <div className="flex items-center gap-2.5">
                    <div className={currentTab === tab.path ? 'text-blue-600' : 'text-gray-500'}>
                      {tab.icon}
                    </div>
                    <span
