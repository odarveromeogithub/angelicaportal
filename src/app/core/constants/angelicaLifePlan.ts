...
export const FIELD_CLASSES = {
  ...
  label:
    "text-xs sm:text-sm md:text-sm font-semibold text-gray-700 dark:text-gray-300",
  input:
    "h-9 sm:h-10 md:h-11 rounded-lg border-gray-200 dark:border-slate-700 dark:bg-slate-900/70 text-xs sm:text-sm md:text-base w-full",
  select:
    "w-full h-9 sm:h-10 md:h-11 rounded-lg border-gray-200 dark:border-slate-700 dark:bg-slate-900/70 text-xs sm:text-sm md:text-base",
  button: {
    base: "rounded-lg text-xs sm:text-sm md:text-sm font-semibold uppercase tracking-wide transition-all duration-200",
    primary:
      "h-10 sm:h-11 md:h-12 px-4 sm:px-6 md:px-8 !bg-blue-600 !text-white hover:!bg-blue-700 active:!bg-blue-800 disabled:!bg-gray-300 disabled:cursor-not-allowed",
    secondary:
      "h-10 sm:h-11 md:h-12 px-3 sm:px-6 md:px-8 border border-gray-300 dark:border-slate-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-800 active:bg-gray-100",
    success:
      "h-10 sm:h-11 md:h-12 px-3 sm:px-6 md:px-8 !bg-green-600 !text-white hover:!bg-green-700 active:!bg-green-800 disabled:!bg-gray-300 disabled:cursor-not-allowed",
    danger:
      "h-9 sm:h-10 md:h-11 px-3 sm:px-4 md:px-6 !bg-red-600 !text-white hover:!bg-red-700 active:!bg-red-800",
    light:
      "h-10 sm:h-11 md:h-12 px-4 sm:px-6 md:px-8 !bg-blue-100 !text-blue-600 hover:!bg-blue-200 active:!bg-blue-300 dark:!bg-blue-900/40 dark:!text-blue-300",
  },
};
