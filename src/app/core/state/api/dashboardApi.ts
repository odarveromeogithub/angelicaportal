...
import type { Plan, ClientPlan, Agent, User, WaitingList } from '../../interfaces/dashboard.interface';
...
export const dashboardApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    // Clients
    getClients: builder.query<ClientPlan[], void>({
    ...
    // Waiting List
    getWaitingList: builder.query<WaitingList[], void>({
      query: () => 'dashboard/waiting-list',
